...
function ProgressRing({ value, maxValue, label, color }: {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative h-24 w-24 rounded-full bg-slate-700/50">
  ...
  if (!hasData) {
    return (
      <div className="rounded-lg border border-slate-700 bg-slate-800 p-12 text-center">
        ...
        <h3 className="mt-4 text-lg font-medium text-white">No season data yet</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-6 flex flex-col items-center">
          <ProgressRing
        ...
        {/* Hours Breakdown */}
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-6 sm:col-span-2 lg:col-span-1">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-white">{data.bookedHoursThisSeason}h</span>
            </div>
            <div className="flex justify-between">
      ...
      <div className="rounded-lg border border-slate-700 bg-slate-800 p-4 sm:p-6">
        <h3 className="text-base font-semibold text-white mb-4">Season Comparison</h3>
              ...
              <>
                ...
                {data.yearOverYearChange !== null && (
                  <div className={`flex items-center justify-center gap-1 text-xs mt-1 ${
                    data.yearOverYearChange >= 0 ? 'text-green-400' : 'text-rose-400'
                  }`}>
      ...
      {data.weatherHoldImpact.totalHolds > 0 && (
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-4 sm:p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-base font-semibold text-white">Weather Hold Impact</h3>
          </div>
