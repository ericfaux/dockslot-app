  ...
  return (
    <div className="rounded-lg border border-slate-700 bg-slate-800 p-4 sm:p-6">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h3 className="text-base sm:text-lg font-semibold text-white">Customer Insights</h3>
      </div>
            ...
            <div className="rounded-lg bg-cyan-500/10 border border-cyan-500/30 p-3">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-cyan-400/80">Most Popular Trip</p>
              ...
              {metrics.tripTypeBreakdown.slice(0, 4).map((trip) => (
                <div key={trip.name} className="space-y-1">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-300 truncate max-w-[60%]">{trip.name}</span>
