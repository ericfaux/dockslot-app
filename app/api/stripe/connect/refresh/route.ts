...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Redirect rather than returning JSON 500: this endpoint is hit via
    // browser navigation, and a bare 500 drops the captain onto Chrome's
    // error page with no path back. Sync-failed lands them on the
